...
Elm.Sample.make = function (_elm) {
   "use strict";
   _elm.Sample = _elm.Sample || {};
   if (_elm.Sample.values) return _elm.Sample.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   var NoOp = {ctor: "NoOp"};
   var Model = {};
   return _elm.Sample.values = {_op: _op,Model: Model,NoOp: NoOp,init: init,update: update,view: view};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Sample = Elm.Sample.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $StartApp = Elm.StartApp.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var app = $StartApp.start({init: $Sample.init,update: $Sample.update,view: $Sample.view,inputs: _U.list([])});
   var main = app.html;
